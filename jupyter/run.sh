...
docker run -it --name jupyter --rm -p 8888:8888 -v "$dir":/home/jovyan/dir -v curso_transform.ipynb:/home/jovyan/curso_transform.ipynb -d jupyter/datascience-notebook \
