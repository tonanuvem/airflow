...
docker run -d --rm -p 8088:8088 --name superset_app -v "$dir/superset:/app/superset_home/superset" --env SUPERSET_SECRET_KEY=fiap --net local_default apache/superset
